...
const COPY = {
  strapp: {
    ...
    presets: [
      [
        ...
        "Your site loads quickly on any phone and works smoothly on slower networks.",
      ],
      [
        "Easy Customer Contact",
        "Customers can message you on WhatsApp or call directly from your site.",
      ],
      [
        "Visible on Google",
        "Built so Google finds and shows your business to local customers searching for what you do.",
      ],
    ],
  ...
  industrial: {
    ...
    presets: [
      [
        "Clean, Simple Design",
        "Easy for customers to find your yard, warehouse, or depot and get your contact info.",
      ],
      ["Direct Phone & WhatsApp", "Buyers and partners reach you instantly through your website."],
      [
        "Accurate on Google Maps",
        "Your exact location and hours show up when suppliers and customers search.",
      ],
    ],
  ...
  retail: {
    ...
    presets: [
      ...
      [
        "Found When They're Hungry",
        "Show up on Google and Maps when locals search for food like yours.",
      ],
    ],
  ...
  professional: {
    ...
    presets: [
      [
        ...
        "Your credentials and services presented clearly to build client trust.",
      ],
      [
        "Easy Consultation Booking",
        "Clients can contact you and book appointments directly from your site.",
      ],
      [
        "Trusted on Google",
        "Show up professionally when potential clients search for your expertise.",
      ],
    ],
...
const PROOF_CARDS = [
  ...
  },
  {
    ...
    description:
      "Clients see measurable customer enquiries from Maps and Search once visibility is live.",
  },
  {
...
const FAQ_ITEMS = [
  {
    question: "How long before my business shows up on Google?",
    answer:
      "Your profile goes live within 24–48 hours. Google usually shows it fully on Search and Maps within a week. We send you verification updates at the 3-day and 14-day marks so you can see it's working.",
  },
  {
    question: "What's included in the R500 service?",
    answer:
      "The R500 covers everything to get you on Google Search and Maps: setting up your business profile, adding your location and hours, setting up WhatsApp messaging, and getting calls routed to your phone. One flat fee, no surprise costs. Custom websites are quoted separately.",
  },
  {
    question: "Do I own the website once it's built?",
    answer:
      "Yes, completely. You own the website, the code, your domain, and all your content from day one. We don't keep any ownership stakes. Once we deliver, the website is yours to keep, change, or move wherever you want.",
  },
  {
    question: "Will my website work on slow mobile networks?",
    answer:
      "Yes. We build everything to load fast even on older phones and slow networks common in South Africa. Your site will work smoothly on 3G/4G networks. We also give you a dashboard to see how fast your site actually runs for your customers.",
  },
  {
    question: "How do you protect my customer data?",
    answer:
      "Your data is protected. We follow South Africa's privacy law (POPIA). We don't share your customer information with anyone. Everything is encrypted when it travels online. We only keep the basic details needed to run your site—nothing else.",
  },
  {
    question: "Can I change or upgrade the website later?",
    answer:
      "Yes. After we deliver it, you have full control. You can hire any developer to change it, add features, move it to a different host, or rebrand it completely. We give you full access to everything.",
  },
];
...
function Index() {
  ...
  const [inlineValues, setInlineValues] = React.useState({
    firstName: "",
    businessName: "",
    email: "",
  });
  ...
  const ABOUT_CARDS = [
    ...
    },
    {
      ...
      body: [
        "Your business shows up when locals search. More visibility. More enquiries. More growth.",
      ],
      variant: "surface-md",
    ...
    },
    {
      ...
      body: [
        "Fast-loading sites that convert local visitors into paying customers. Built for Durban networks.",
      ],
      variant: "surface-md",
    ...
    },
    {
      ...
      body: [
        "We're backed by Durban's leading tech ecosystem. Vetted. Proven. Trusted by local founders and businesses.",
      ],
      variant: "surface-md",
    ...
    },
    {
      ...
      body: [
        '"They get what we\'re trying to do. No fluff. Just results that matter to our business."',
      ],
      variant: "surface-md",
  ...
  React.useEffect(() => {
    document.documentElement.setAttribute(
      "data-theme",
      activeMode === "strapp" ? "strapp" : activeMode,
    );
  ...
  const sendLead = async (payload: Record<string, string>) => {
    const response = await fetch(
      "https://ktlrlmreaqkcbwwcqobw.supabase.co/functions/v1/contact-email",
      {
        method: "POST",
  ...
  const acceptCookies = () => {
    localStorage.setItem(
      "rt_popia",
      JSON.stringify({ essential: true, analytical: analyticsEnabled, ts: Date.now() }),
    );
  ...
  return (
    <>
      <nav className="dotnav" aria-label="section navigation">
        <button className="dot" type="button" data-target="sec1" onClick={() => goTo("sec1")}>
          ◐ welcome
        </button>
        <button className="dot" type="button" data-target="sec2" onClick={() => goTo("sec2")}>
          ◧ visibility
        </button>
        <button className="dot" type="button" data-target="sec3" onClick={() => goTo("sec3")}>
          ◩ websites
        </button>
        <button className="dot" type="button" data-target="sec4" onClick={() => goTo("sec4")}>
          ◉ pricing
        </button>
        <button className="dot" type="button" data-target="sec5" onClick={() => goTo("sec5")}>
          ◈ contact
        </button>
        <button className="dot" type="button" data-target="sec6" onClick={() => goTo("sec6")}>
          ◈ faqs
        </button>
        <button className="dot" type="button" data-target="sec7" onClick={() => goTo("sec7")}>
          ◉ about us
        </button>
      </nav>
      ...
      <section id="sec1">
        ...
        <span className="meta bl" aria-live="polite">
          {current.label}
        </span>
        <span className="meta br">{clock}</span>

        <h1 className="strapp-text">
          <span>sync up</span>
          <span className="dots">.</span>
        </h1>
        <p className="strapp-subtext">Local businesses found faster on Google.</p>
        <p className="strapp-subtext" style={{ marginTop: 8, fontWeight: 500 }}>
          Websites and Google presence built for Durban and South African businesses that need more
          customer enquiries.
        </p>
        <div
        ...
        <div className={`mode-array ${modeReady ? "show" : ""}`}>
          {(Object.keys(COPY) as Array<keyof typeof COPY>)
            .filter((mode) => mode !== "strapp")
            .map((mode) => (
              <button
                key={mode}
        ...
        <div className="cta-row" style={{ marginTop: 24 }}>
          <button className="cta" type="button" onClick={() => goTo("sec5")}>
            Start Local Growth
          </button>
          <button className="cta ghost" type="button" onClick={() => goTo("sec4")}>
            See how we help
          </button>
        </div>
      </section>
        ...
        <div className="engine-wrap">
          <div>
            ...
            <div className="cta-row">
              ...
              <button className="cta ghost" type="button" onClick={() => goTo("sec5")}>
                Talk To Us
              </button>
            </div>
          </div>
      ...
      <section id="sec4">
        ...
        <div className="dash">
          ...
          <div className="cell">
            ...
            <div className="stat">
              <b>Visibility Setup:</b> R500 one-off for Google Profile setup, Maps verification, and
              customer contact readiness.
              <br />
              <br />
              <b>Website Projects:</b> transparent deposit, milestone payments, and final launch
              payment when you approve the site.
            </div>
          </div>
          <div
            className="cell"
          ...
          >
            <div>
              ...
              <div className="stat">
                Whether you need better Google visibility or a professional website, sync up helps
                Durban businesses get more local customers.
              </div>
            </div>
            <button
              className="cta"
            ...
            <div>
              ...
              {inlineSuccess ? (
                <div className="success-state">
                  ...
                  <div className="msg">Thank you. We'll be in touch quickly.</div>
                </div>
              ) : (
                <form
                  id="contactFormInline"
                ...
                >
                  <div className="form-field">
                    ...
                    <input
                      ...
                      value={inlineValues.firstName}
                      onChange={(e) =>
                        setInlineValues({ ...inlineValues, firstName: e.target.value })
                      }
                    />
                  ...
                  <div className="form-field">
                    ...
                    <input
                      ...
                      value={inlineValues.businessName}
                      onChange={(e) =>
                        setInlineValues({ ...inlineValues, businessName: e.target.value })
                      }
                    />
          ...
          <div className="about-track">
            {[...ABOUT_CARDS, ...ABOUT_CARDS].map((card, index) => (
              <article className={`surface ${card.variant}`} key={`${card.key}-${index}`}>
                {card.visual ? (
                  <div className={`surface-visual-top ${card.visualClass || ""}`}>
                    {card.visual}
                  </div>
                ) : null}
                ...
                <div className="surface-body">
                  ...
                  {card.ctaText ? (
                    <>
                      ...
                      {card.footerImage ? (
                        <div className="surface-footer-image">{card.footerImage}</div>
                      ) : null}
                    </>
                  ) : null}
                </div>
      ...
      <button
        className={`return-sticky ${activeMode !== "strapp" ? "show" : ""}`}
        type="button"
        onClick={() => setActiveMode("strapp")}
      >
        ↺ return to sync up original core
      </button>
      ...
      <button
        ...
        onClick={() => {
          const text = encodeURIComponent(
            "Hello Sync Up — I'd like to grow my business with Google visibility and a website.",
          );
          window.open(`https://wa.me/27687856507?text=${text}`, "_blank");
        }}
      >
        WhatsApp Us
      </button>
      ...
      <div className={`cookie-overlay ${cookieVisible ? "show" : ""}`} aria-hidden={!cookieVisible}>
        <aside
          ...
          role="dialog"
          aria-modal="true"
          aria-label="POPIA consent dialog"
        >
          <div className="cookie-inner">
            <h4>POPIA Compliance & Session Cryptography</h4>
            <p>
              Sync Up operates under mandatory functional state tracking and statistical metric
              logging under the South African Protection of Personal Information Act (POPIA, 2013).
              Essential operational data (theme configuration, authentication state, session
              identifiers) persists exclusively on your local device, encrypted at rest. Statistical
              metrics collection requires explicit authorized consent. Zero third-party data
              syndication. All transmission pathways employ TLS encryption protocols.
            </p>
            <div className="opts">
              <label>
                <input type="checkbox" checked disabled /> mandatory functional state tracking
              </label>
              <label>
                <input
                  type="checkbox"
                ...
                />{" "}
                authorized statistical metric logging
              </label>
            </div>
            <div className="row">
              <span className="legal">
                · sync up · zero external data sharing · locally persisted
              </span>
              <button ref={acceptBtnRef} className="accept" type="button" onClick={acceptCookies}>
